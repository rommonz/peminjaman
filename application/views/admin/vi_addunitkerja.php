      ...
      <?php $this->load->view('flashdata') ?>
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo site_url('admin/unitkerjasave'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">

                          <div class="row form-group">
                                <div class="col col-md-3"><label for="kd" class=" form-control-label">Nama Unit Kerja</label></div>
                                <div class="col-12 col-md-9"><input type="text" id="nama_unit_kerja" name="nama_unit_kerja" placeholder="Nama Unit Kerja" class="form-control" required></div>
                          </div>
