      ...
      <?php $this->load->view('flashdata') ?>
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                        <form action="<?php echo site_url('admin/pagumaminsave'); ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="col col-md-3">
                               ...
                               <div class="col-12 col-md-9">
                                    ...
                                    <?php foreach($daftar_unit_kerja as $uk) { ?>
                                      <option value="<?php echo $uk->id_unit_kerja ?>"><?php echo $uk->nama_unit_kerja ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                          </div>
                          <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" id="nilai_pagu" name="nilai_pagu" placeholder="Nilai Pagu" class="form-control" required></div>
                          </div>
                          <div class="row form-group"> <!--dibuat dropdown-->
                            <div class="col col-md-3">
                               ...
                               <div class="col-12 col-md-9">
                                    ...
                                    <?php $x=2020; while($x<=2030){ ?>
                                      <option <?php echo date('Y') == $x ? 'selected' : '' ?> value="<?php echo $x ?>"><?php echo $x++ ?></option>
                                    <?php } ?>
                                    </select>
                                </div>
                          </div>
